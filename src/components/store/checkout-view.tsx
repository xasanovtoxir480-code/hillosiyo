...
export function CheckoutView() {
  ...
  return (
    ...
    >
      {/* Header - sticky */}
      <div className="shrink-0 bg-white border-b shadow-sm z-40">
      ...
      <div className="shrink-0 bg-white border-t shadow-[0_-4px_12px_rgba(0,0,0,0.08)] px-4 py-4 z-40">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-3">
            <span className="text-sm text-gray-500">Jami ({items.length} ta)</span>
